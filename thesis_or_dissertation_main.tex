...
%
% 2. The package 'amsmath' is automatically loaded by the class. (For reasons explained in the class file, it would not be practical to try to avoid loading amsmath.) 
